...
public class KassapaateTest {
    ...
    public void kortiltaVelotetaanHintaJosRahaaOn() {
        ...
        verify(kortti).osta(kassa.HINTA);
    }
    ...
    public void kortiltaEiVelotetaJosRahaEiRiita() {
        ...
        verify(kortti, times(1)).getSaldo();
        verify(kortti, times(0)).osta(kassa.HINTA);
    }

    @Test
    public void lataaKortiltaJosArvoa() {
    ...
    @Test
    public void latausEiTeeMitaanJosNegatiivinenLataus() {
        kassa.lataa(kortti, -5);
